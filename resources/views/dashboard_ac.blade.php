...
<main class="d-flex flex-nowrap">
    <div class="flex-shrink-0 p-3 bg-white" style="width: 300px; ">
        <a href="/" class="d-flex align-items-center pb-2 mb-1 link-dark text-decoration-none border-bottom">
            <svg class="bi pe-none me-2" width="15" height="18">
...
{{--        <ul class="navbar-nav">--}}
{{--                <li class="nav-item">--}}
{{--                    <a href="" class="nav-link" data-bs-toggle="offcanvas" data-bs-target="#demo">profile</a>--}}
{{--                </li>--}}
{{--                <li class="nav-item">--}}
