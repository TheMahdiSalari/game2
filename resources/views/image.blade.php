        ...
        <table class="table">
            ...
            @foreach($photos as $photo)
                <tr>
                    <td>{{ $photo->id }}</td>
                    <td>{{ $photo->name }}</td>
                    <td class="text-center font-medium" style="font-size: 15px">{{ $photo->size }} KB</td>
                    <td>
                        <form action="upload-image" method="post">
                            @csrf
                            <button class="btn btn-dark px-3" style="font-size: 12px">{{ $photo->format }}</button>
                        </form>
                    </td>
                    <td>{{ $photo->created_at }}</td>
                    <td><button class="btn btn-info px-2 text-white " style="font-size: 10px">{{ $photo->dimension }}</button></td>
                    <td><a href="{{ url($photo->path) }}"><button class="btn btn-light px-2 " style="font-size: 12px">
