    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #F2C98A">
            ...
            <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                ...
                <!--end::Content-->
                <!--begin::Illustration-->
                <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url(/asset/media/illustrations/dozzy-1/13.png)"></div>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
        </div>
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#" method="post">
                        ...
                        <div class="text-center mb-10">
                            ...
                            <div class="text-gray-400 fw-bold fs-4">New Here?
                                <a href="{{ url('sign_up') }}" class="link-primary fw-bolder">Create an Account</a></div>
                            <!--end::Link-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <div class="d-flex flex-stack mb-2">
                                ...
                                <!--end::Label-->
                                <!--begin::Link-->
                                <a href="../../demo3/dist/authentication/layouts/aside/password-reset.html" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Input-->
